      ...
      <div>
        <Grid container spacing={3} alignItems="flex-center" justify="space-evenly" direction="row">
          <Grid item xs={5} style={{ display: 'flex-inline' }}>
            ...
            <TextField id="shipper_name" margin="dense" value="Mr Shipper A" variant="outlined" fullWidth />
            <TextField id="shipper_add1" margin="dense" value="Block AAA Loyang #01-01" variant="outlined" fullWidth/>
            <TextField id="shipper_add2" margin="dense" value="Address Line 2" variant="outlined" fullWidth/>
            <TextField id="shipper_contact" margin="dense" value="9123 1234" variant="outlined" fullWidth/>
            <TextField id="shipper_email" margin="dense" value="shipperA@shipper.com" variant="outlined" fullWidth />
          </Grid>
          ...
          <Grid item xs={5}>
            ...
            <TextField id="consignee_name" margin="dense" value="Mr Consignee B" variant="outlined" fullWidth/>
            <TextField id="consignee_add1" margin="dense" value="Block BBB Jurong Industry #01-09" variant="outlined" fullWidth />
            <TextField id="consignee_add2" margin="dense" value="Address Line 2" variant="outlined" fullWidth/>
            <TextField id="consignee_contact" margin="dense" value="9343 3453" variant="outlined" fullWidth/>
            <TextField id="consignee_email" margin="dense" value="consigneeB@consignee.com" variant="outlined" fullWidth/>
          </Grid>
