        ...
        <Box borderColor="text.primary" {...boxProps}>
          ...
          <Grid container spacing={1} style={{ margin: "10px" }} >
            ...
            <Grid item xs={3} align="right" >
              <TextField size="small" value="Cargo A" variant="outlined" />
            </Grid>
            ...
            <Grid item xs={3} align="left">
              <form noValidate autoComplete="off">
                <TextField size="small" style={{ width: "185px" }} value="ABC12345" variant="outlined" />
              </form>
            </Grid>
            <Grid item xs={2} align="left" >
            ...
            <Grid item xs={3} align="right" >
              <TextField size="small" value="50" variant="outlined" />
            </Grid>
            <Grid item xs={1} align="right" >
            </Grid>
            <Grid item xs={3} align="left">
            ...
            <Grid item xs={2} align="right">
              <form noValidate autoComplete="off">
                <TextField size="small" value="100" variant="outlined" />
              </form>
            </Grid>
